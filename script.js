...
async function displayAlbums() {
    ...
    for (let index = 0; index < array.length; index++) {
        ...
        if (e.href.includes("/songs")) {
            ...
            <div class="play">
                <div
                    style="width: 50px; height: 50px; background-color: #1fdf64; border-radius: 50%; display: flex; justify-content: center; align-items: center;">
...
async function main() {
    ...
    // Add an eventlistner prevoius and next
